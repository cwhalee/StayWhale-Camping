...
public class Camping_ALL {
	...
	public void setReg_num_c(String reg_num_c) {
		this.reg_num_c = reg_num_c;
	}
	...
	public String getAcc_picture() {
		return acc_picture;
	}
	public void setAcc_picture(String acc_picture) {
		this.acc_picture = acc_picture;
	}
